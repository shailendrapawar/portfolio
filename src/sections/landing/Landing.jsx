...
// Simple entrance variant for text (fade + slide up)
const textReveal = {
...
function Landing() {
  ...
  return (
    <div ref={ref} className="relative min-h-[calc(100vh-80px)] flex justify-center ">
      {isVisible && (
        <section className="landing-slide min-h-[calc(100vh-80px)] w-full max-w-250 grid-background flex flex-col sm:flex-row">
          <main className="h-[50%] w-full p-3 flex flex-col justify-center items-start gap-8 sm:h-full sm:w-[50%] sm:gap-15 sm:pl-10 ">
            ...
            >
              Hi, I'm <span style={{ color: currentTheme.accent }}>Shailendra Pawar</span>
            </motion.h3>
            ...
            <motion.h1
              ...
              style={{ color: currentTheme.secondaryAccent }}
            >
            ...
            <motion.p
              ...
              className="w-[80%] text-sm sm:text-lg md:text-xl"
            ...
            <motion.div
              ...
              className="h-10 w-55 sm:w-65 sm:h-12 md:w-80 md:h-14 flex gap-2 "
              style={{ color: currentTheme.textPrimary }}
            >
              <a
                className="w-[50%] h-full cursor-pointer rounded-tl-3xl text-white transition-all hover:w-[70%] sm:text-lg md:text-2xl shadow-sm shadow-black active:shadow-none flex items-center justify-center"
                href={urls.resume}
                target="_blank"
              ...
              <button
                className="w-[50%] h-full cursor-pointer rounded-br-3xl sm:text-lg  md:text-2xl transition-all hover:w-[70%] "
          ...
          <aside className=" h-[50%] w-full relative flex justify-center items-center   sm:h-full sm:w-[50%] sm:pr-10">
            <div className="h-60 w-50 relative flex items-center justify-center sm:h-80 sm:w-65 md:h-95 md:w-80">
              ...
              <img
                src={currentTheme.name == "light" ? `${lightWizzard}` : `${darkWizzard}`}
